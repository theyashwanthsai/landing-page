...
const Hero: React.FC = () => {
  ...
  className="text-center py-5 px-8 rounded-xl backdrop-blur-[2px] bg-gradient-to-br from-black/60 via-purple-900/20 to-black/60 border-t border-l border-purple-500/15 border-r border-b border-white/5 shadow-[0_4px_20px_rgba(123,58,180,0.2)] max-w-3xl mx-auto"
>
      <motion.h1
        className="text-5xl md:text-7xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-purple-400 drop-shadow-[0_0_15px_rgba(168,85,247,0.5)]"
        initial={{ opacity: 0, y: 20 }}
      ...
      <motion.p
        className="text-lg md:text-xl text-gray-200 mb-6 max-w-2xl mx-auto drop-shadow-[0_0_2px_rgba(255,255,255,0.3)]"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
