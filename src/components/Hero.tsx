...
const Hero: React.FC = () => {
  return (
<section className="h-screen flex items-start justify-center overflow-hidden pt-40 md:pt-64">
      <ThreeScene />
      ...
      <div className="container mx-auto px-4 z-10 max-w-5xl">
        <motion.div
          ...
          className="text-center py-4 sm:py-5 px-6 sm:px-8 rounded-xl backdrop-blur-[2px] bg-gradient-to-br from-black/50 
          via-purple-900/20 to-black/50 border-t border-l border-white/5 border-r border-b border-white/5 shadow-[0_4px_20px_rgba(123,58,180,0.2)]
           max-w-3xl mx-auto"
        >
          <motion.h1
            className="text-4xl sm:text-5xl md:text-7xl font-bold mb-3 sm:mb-4 bg-clip-text text-transparent 
