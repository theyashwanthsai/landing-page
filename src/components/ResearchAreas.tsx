      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        >
          <motion.div variants={itemVariants} className="text-center">
            <h2 className="text-5xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-500">
          ...
          >
            {researchAreas.map((area, index) => (
              <motion.div
                ...
                className="bg-gray-900/30 backdrop-blur-sm p-8 rounded-lg border border-purple-900/30 hover:border-purple-500/50 transition-all duration-300"
                whileHover={{ 
                  scale: 1.03,
          ...
          >
            <div className="text-center">
              <h3 className="text-5xl font-bold text-white mb-4">Stay Connected</h3>
