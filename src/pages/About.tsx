          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="px-4 sm:px-6 py-8">
              ...
              <img src="/images/team.png" alt="Turi Labs" className="w-full md:w-[90%] max-w-lg rounded-xl shadow-2xl" />
                ...
                <br />
                While we all maintain full-time careers, TuriLabs represents our collective passion for AI. Though not yet formally incorporated, this is a fully functional team of independent researchers.
                <br />
                <br />
